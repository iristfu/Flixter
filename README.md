...
1. How to implement a movie search functionality
2. How we can connect individual collection cells to the same details view controllers as where our table view controller cells lead

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='[https://i.imgur.com/aq5SxbH.mp4' title='Video Walkthrough](https://github.com/iristfu/Flixter/blob/main/Flixter.gif)' width='' alt='Video Walkthrough' />
